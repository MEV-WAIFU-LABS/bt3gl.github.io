...
In addition to this list, you can check some specific web exploration older posts: [Exploiting the web in 20 lessons](http://singularity-sh.vercel.app/exploiting-the-web-in-20-lessons-natas.html) and [D-Camp CTF 2014](http://singularity-sh.vercel.app/exploring-d-ctf-quals-2014s-exploits.html).
