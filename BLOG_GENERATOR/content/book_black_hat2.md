Title: Black Hat Python: Infinite possibilities with the Scapy Module
Date: 2014-12-22
Category: Networking
...
Let's start by specifying the packet's source IP and then its destination IP. This type of information goes in the **IP header**, which is a *layer 3 protocol* in the [0SI model](http://singularity.miavonsteinkirch.com/wiresharking-for-fun-or-profit.html):
...
I talked about [ARP cache poisoning using command line arpspoof](http://singularity.miavonsteinkirch.com/wiresharking-for-fun-or-profit.html) in my guide about Wireshark. Here we are going to see how to implement a similar tool using Scapy.
...
The best way to test this is by using a Windows virtual machine (take a look in [this guide I wrote](http://singularity.miavonsteinkirch.com/setting-up-a-playing-environment-with-virtual-machines.html)).
